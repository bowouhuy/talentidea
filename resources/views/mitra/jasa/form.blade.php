        ...
        <div class="card">
            <div class="card-body">
                <div class="row mb-3">
                    ...
                    <div class="col-md-6 text-right"><a href="{{url('mitra/jasa')}}" class="btn btn-secondary text-right px-5"><i class="fa fa-angle-left"></i> Kembali </a></div>
                </div>
                <hr>
                <form action="{{url('mitra/jasa/form_jasa_store')}}" method="post">
                @csrf
