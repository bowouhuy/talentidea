        ...
        <div class="card">
            <div class="card-body">
                <div class="row mb-3">
                    ...
                    <div class="col-md-6 text-right"><a href="{{url('admin/jasa/form_jasa')}}" class="btn btn-primary text-right px-5"><i class="fa fa-plus mr-1"></i> Tambah Data </a></div>
                </div>
    ...
    function delete_jasa(jasa_id){
        swal({
            ...
            if (result) {
                $.ajax({
                    type: 'GET',
                    url: '{{ url("admin/jasa/delete_jasa")}}' + '/' + jasa_id,
                    success: function (data){
                        ...
                        'success'
                            ...
                            window.location.replace("{{ url('admin/jasa')}}")
                        })
                    },
                    error: function(e) {
                        console.log(e);
