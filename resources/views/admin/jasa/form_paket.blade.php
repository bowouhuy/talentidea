    ...
    <div class="col-xl-12 col-md-12">
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <a href="{{url('admin/jasa/form_images',$jasa_id)}}" class="btn btn-secondary px-3"><i class="fa fa-angle-left"></i> Sebelumnya</a>
                    </div>
                    <div class="col-sm-6 text-right">
                        <a href="{{url('admin/jasa')}}" class="btn btn-primary">Selesai <i class="fa fa-check"></i></a>
                    </div>
                </div>
            </div>
        </div>
...
<div id="paketModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{url('admin/jasa/form_paket_store')}}" method="post">
            @csrf
    ...
    function delete_paket(paket_id, jasa_id){
        swal({
            ...
            if (result) {
                $.ajax({
                    type: 'GET',
                    url: '{{ url("admin/jasa/delete_paket")}}' + '/' + paket_id,
                    success: function (data){
                        swal(
                        'Deleted!',
                        ...
                        'success'
                            ...
                            window.location.replace("{{ url('admin/jasa/form_paket')}}" + "/" + jasa_id)
                        })
                    },
                    error: function(e) {
                        console.log(e);
