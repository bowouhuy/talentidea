        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="form-group row">
                    <div class="col-sm-12">
                        <form action="{{url('admin/jasa/form_images_store')}}" class="dropzone" id="dropzone" method="post">
                        @csrf
                ...
                <div class="form-group row">
                    <div class="col-sm-6">
                        <a href="{{url('admin/jasa/form_jasa',$jasa_id)}}" class="btn btn-secondary px-3"><i class="fa fa-angle-left"></i> Sebelumnya</a>
                    </div>
                    <div class="col-sm-6 text-right">
                        <a href="{{url('admin/jasa/form_paket',$jasa_id)}}" class="btn btn-primary px-3">Selanjutnya <i class="fa fa-angle-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
